...
$site_top = "http://www.alfa-st.co.jp";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "info@alfa-st.co.jp,tremolorj09@gmail.com";
...
$require = array('お問い合わせ内容','会社名','フリガナ','携帯電話番号','Email','撮影内容','撮影希望スタジオ');
